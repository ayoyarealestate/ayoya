...
$(function(){
  $('.tab-wrapper.v1 .item .tab-btn a').click(function(e){
    ...
    if(_item.hasClass(_hasClass)){
      _item.find('.tab-btn a em').removeClass('fa fa-angle-up').addClass('fa fa-angle-down')
            .closest('.item')
            .find('.tab-content')
      ...
      _all.find('.tab-btn a em').removeClass('fa fa-angle-up').addClass('fa fa-angle-down')
            .closest('.item')
            .find('.tab-content')
            .stop()
            .slideUp(400, function(){
      ...
      _item.find('.tab-btn a em').removeClass('fa fa-angle-down').addClass('fa fa-angle-up')
            .closest('.item')
            .find('.tab-content')
            .stop()
  ...
  $('.tab-wrapper.v2 .tab-btn a').click(function(e){
    ...
    if(_this.hasClass(_hasClass)){
      ...
      _all.removeClass(_hasClass).find('em').removeClass('fa fa-angle-down').addClass('fa fa-angle-up');
      _this.addClass(_hasClass).find('em').removeClass('fa fa-angle-up').addClass('fa fa-angle-down');
